{
  "Comment": "For tables: creates metadata in Glue Catalog, exports data to S3, returns row count table, then triggers a state machine to export views or to delete the RDS DB instance.",
