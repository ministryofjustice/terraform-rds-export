{
  ...
  "States": {
    ...
    "RowCount Updater": {
      ...
      "Next": "Prepare Input for Database Views",
      "ResultPath": "$.LambdaResult"
    },
    "Prepare Input for Database Views": {
      "Type": "Pass",
      "Parameters": {
        "db_name.$": "$.db_name",
        "extraction_timestamp.$": "$.extraction_timestamp",
      ...
      "Next": "call database-export-views Step Functions"
    },
    "call database-export-views Step Functions": {
      "Type": "Task",
      "Resource": "arn:aws:states:::states:startExecution.sync",
      "Parameters": {
        "StateMachineArn": "${DatabaseExportViewsStateMachineArn}",
        "Input.$": "$"
      },
      "Next": "Success State",
      "ResultPath": null
